...
class Update(base.Command):
  ...
  def Args(cls, parser):
    ...
    if cls.ReleaseTrack() == base.ReleaseTrack.ALPHA:
      arguments.AddSemanticsMutexGroupArgs(parser)
  ...
  def Run(self, args):
    ...
    if 'add_semantics' in args and args.IsSpecified('add_semantics'):
      tag_value.semantics = args.add_semantics
      update_masks.append('semantics')
    elif 'remove_semantics' in args and args.IsSpecified('remove_semantics'):
      update_masks.append('semantics')
      tag_value.semantics = None

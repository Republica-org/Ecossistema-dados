WITH tabela_1 AS (
 ...
 SELECT 
  ...
  CASE 
    WHEN faixa_remuneracao_media_sm = '0' THEN 'Até 0,50 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '1' THEN '0,51 a 1,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '2' THEN '1,01 a 1,50 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '3' THEN '1,51 a 2,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '4' THEN '2,01 a 3,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '5' THEN '3,01 a 4,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '6' THEN '4,01 a 5,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '7' THEN '5,01 a 7,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '8' THEN '7,01 a 10,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '9' THEN '10,01 a 15,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '10' THEN '15,01 a 20,00 salários mínimos'
    WHEN faixa_remuneracao_media_sm = '11' THEN 'Mais de 20,00 salários mínimos' 
  END AS faixa_remuneracao_media,

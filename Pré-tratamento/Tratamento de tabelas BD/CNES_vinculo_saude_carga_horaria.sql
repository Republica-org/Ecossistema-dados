WITH profissionais AS (
  SELECT 
    ...
    carga_horaria_ambulatorial + carga_horaria_hospitalar + carga_horaria_outros as carga_horaria_total,
    COUNT(*) as n_profissionais
  FROM `basedosdados-dev.br_ms_cnes.profissional`
  WHERE mes = 1
  GROUP BY 1,2,3,4),
...
SELECT 
  ...
  profissionais.carga_horaria_total,
